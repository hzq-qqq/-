...
<div id="yp_doc">
    <table>
        ...
        <tr>
        <tr>
            <td><h3><a href="#">${sessionScope.doc.dname}</a></h3></td>
            <td><h3><a href="#">${sessionScope.doc.dsize}KB</a></h3></td>
            <td><h3><a href="#">${sessionScope.doc.dupload}</a></h3></td>
        </tr>
        </tr>
    </table>
</div>
<div id="fileForm">
    <div id="upload">
        ...
        <form class="form-control" action="fileUpload?fid=${sessionScope.fid}" method="post" enctype="multipart/form-data">
            ...
            <input type="submit" onclick="" value="上传" class="button button-3d button-primary button-rounded"/>
        </form>
    </div>
    <div id="folder">
        <br/>
